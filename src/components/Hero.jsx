            ...
            <div className="row g-4 justify-content-center justify-content-md-between align-items-center">
              <div className="col-6 col-md-4 col-lg-2">
                <div className="card text-center m-auto">
                  <img src={icon} className="card-img-top img-fluid m-auto" alt="Fast Orders" />
              ...
              <div className="col-6 col-md-4 col-lg-2">
                <div className="card text-center m-auto">
                  <img src={icon1} className="card-img-top img-fluid m-auto" alt="Quick Shipping" />
                  <div className="card-body">
              ...
              <div className="col-6 col-md-4 col-lg-2">
                <div className="card text-center m-auto">
                  <img src={icon2} className="card-img-top img-fluid m-auto" alt="High Saves" />
                  <div className="card-body">
              ...
              <div className="col-6 col-md-4 col-lg-2">
                <div className="card text-center m-auto">
                  <img src={icon3} className="card-img-top img-fluid m-auto" alt="24/7 Support" />
                  <div className="card-body">
              ...
              <div className="col-6 col-md-4 col-lg-2">
                <div className="card text-center m-auto">
                  <img src={icon4} className="card-img-top img-fluid m-auto" alt="Online Orders" />
                  <div className="card-body">
