      ...
      <div className="container-xxl">
        ...
        <div className="row justify-content-center justify-content-md-start">
          <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
            ...
            <div className='mb-3'><p><b>Follow me on:</b></p> </div>
            <div className="socials d-flex gap-3">
              <Link to='https://www.facebook.com/jagdeesh97' id='footer-link' target='_blank' className='gap-3'>
                <FaFacebook />
              </Link>
              <Link to='https://twitter.com/jagdees64637387' id='footer-link' target='_blank' className='gap-3'>
                <FaXTwitter />
              </Link>
              <Link to={'https://github.com/jagdeesh97/'} className='gap-3' id='footer-link'>
                <BsGithub />
              </Link>
              <Link to='https://www.linkedin.com/in/jagdeesh-kumar/' id='footer-link' target='_blank' className='gap-3'>
                <GrLinkedin />
              </Link>
            </div>
          </div>
          ...
          <div className="col-md-4 col-lg-4 d-flex'">
            ...
            <div className="className='mb-3 col-md-6 col-12 pay d-flex ">
              <div className='mb-3'>
        ...
        <div className="row">
          <div className="col-12 col-md-6">
            <p className="text-center text-md-start">&copy;Developed by Jagdeesh Kumar 2023</p>
          </div>
          <div className="col-12 col-md-6">
